            ...
            <div key={slideIndex} className="office-projects-display">
              {pair.map((project, index) => (
                <div key={`${project.id}-${slideIndex}-${index}`} className="office-project-half">
                                      <div className="office-project-background" style={{ backgroundImage: `url(${getImageUrl(getProjectImage(project))})` }}>
                    <div className="office-project-overlay-content">
                      <div className="office-project-text-content">
                        ...
                        <span onClick={(e) => {
                          console.log('Office project clicked:', project)
                          handleReadClick(e, project.id)
                        }} className="office-read-link">
                          READ
                        </span>
                      </div>
                    </div>
