    ...
    <div className="design-page">
            ...
            <div key={slideIndex} className="projects-display">
              {pair.map((project, index) => (
                <div key={`${project.id}-${slideIndex}-${index}`} className="project-half">
                  <div className="project-background" style={{ backgroundImage: `url(${getImageUrl(getProjectImage(project))})` }}>
                    <div className="project-overlay">
                      <div className="project-content">
                        <h2 className="project-title">{project.title}</h2>
                        <span className="read-text" onClick={() => {
                          console.log('Design project clicked:', project)
      ...
      <div className="filter-section">
        ...
        <div className="social-icons">
          <a href="https://www.facebook.com/nsogyel" className="social-icon">
          ...
          <a href="https://www.instagram.com/namas_design_and_build" className="social-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <a href="https://www.youtube.com/@namasdesignandbuild7925" className="social-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
          ...
          <a href="https://www.tiktok.com/@namas.designbuild" className="social-icon">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
